...
function SkillItem(props) {
  ...
  return (<div ref={containerRef1} className={`${isVisible1 && ((props.index % 2 !== 0) ? 'animate-slide-in' : 'animate-slide-in-left')} opacity-0`} style={{ "--delay": 0.2 + (props.index-1) * 0.4 + "s" }}>
