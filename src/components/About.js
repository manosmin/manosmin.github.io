...
const About = () => {
  return (
    <section id="about" className="p-5 flex flex-col items-center">
      ...
      <p className="mt-2 text-white text-center"> I recently received my masters' degree from <a rel="noopener noreferrer" href="https://www.ceid.upatras.gr" target='_blank' className="hover:underline">Computer Engineering & Informatics Department at University of Patras</a> and I'm on the lookout for my first professional experience in the tech field, seeking to apply my skills and grow within a dynamic team.</p><p className="mt-2 text-white text-center">I am eager to contribute to real-world projects and make a meaningful impact.</p>
    </section>
  );
};
