...
const About = () => {
  return (
    <section id="about" className="bg-gray-900 p-10 flex flex-col items-center">
      ...
      <p className="mt-6 text-center text-slate-200">My name is <span className='font-semibold'>Manos</span>, I live in Heraklion, Greece and I'm 28 years old. I'm a recent Computer Engineering graduate with a balanced knowledge in both hardware and software.</p>
