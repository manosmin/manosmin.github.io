...
const About = () => {
  return (
    <section id="about" className="p-5 flex flex-col items-center">
      ...
      <h2 className="text-2xl text-slate-200	 font-semibold mt-4">About Me</h2>
      <p className="mt-2 text-center text-slate-200">My name is <span className='font-semibold'>Manos Minadakis</span>, I live in Heraklion, Greece and I'm 28 years old. I'm a recent Computer Engineering graduate with a balanced knowledge in both hardware and software.</p>
