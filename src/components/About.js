      ...
      <div id="about" onClick={toggleAccordion} className="cursor-pointer">
        ...
        {isOpen && ( 
          <div className="w-full flex flex-col items-center text-center mt-8 cursor-normal space-y-2"  >
            ...
            <p className='animate-slide-in opacity-0' style={{ "--delay": 1.6 + "s" }}>
            ...
            <p className='animate-slide-in-left opacity-0' style={{ "--delay": 2 + "s" }}>
            ...
            <p className='animate-slide-in opacity-0' style={{ "--delay": 2.4 + "s" }}>I'm eager to contribute to real-world projects and make a meaningful impact, so feel free to <a className="hover:underline" href="mailto:manosmin@hotmail.com">contact me</a> for related opportunities 💬.</p>
          </div>
        )}
      </div>
  );
