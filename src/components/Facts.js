...
function Facts() {
  ...
  return (
    <div id="facts" className='bg-gray-200 text-gray-900 dark:bg-gray-900 dark:text-gray-200 p-10 py-48'>
      ...
      <ul className="mt-8 cursor-normal list-inside list-disc space-y-2">
          ...
          <li ref={containerRef4} className={`opacity-0 ${isVisible4 && "animate-slide-in"}`} style={{ "--delay":  0.4 + "s" }}>In my teenage years, I played for a local basketball team and participated in the juniors' local championship. </li>
      </ul>
    </div>
  )
}
