    ...
    <section id="facts" className="bg-gray-900 text-gray-200 dark:bg-gray-200 dark:text-gray-900 p-10">
      ...
      {isOpen && (
        <ul class="list-inside list-disc">
            <li className='mt-2'>I was trained to be flight dispatcher and worked in the control tower of a small airport on a border island, as part of my military service. 👨🏻‍✈️✈️</li>
