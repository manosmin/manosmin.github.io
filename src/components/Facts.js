    ...
    <div id="facts" onClick={toggleAccordion} className="cursor-pointer">
      ...
      {isOpen && (
        <ul class="mt-8 cursor-normal list-inside list-disc space-y-2">
            ...
            <li className='animate-slide-in opacity-0' style={{ "--delay": 0.4 + "s" }}>In the past, I used to play online poker and had won several tournaments at small stakes, the largest of which had 3600 participants. 🃏🏆</li>
            <li className='animate-slide-in opacity-0' style={{ "--delay":  0.6 + "s" }}>In my teenage years, I played for a local basketball team and participated in the juniors' local championship. ( っ'-')╮ =͟͟͞͞🏀 </li>
        </ul>
        )}
    </div>
  )
