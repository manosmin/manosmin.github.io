    ...
    <section id="facts" className="bg-gray-900 text-gray-200 dark:bg-gray-200 dark:text-gray-900 p-10">
      ...
      {isOpen && (
        <ul class="list-inside list-disc">
            ...
            <li className='mt-2'>In my teenage years, I played for a local basketball team as a shooting guard and participated in the juniors' local championship. ( っ'-')╮ =͟͟͞͞🏀 </li>
        </ul>
        )}
    </section>
  )
