    ...
    <div id="facts" onClick={toggleAccordion} className="cursor-pointer">
      ...
      {isOpen && (
        <ul class="mt-8 cursor-normal list-inside list-disc space-y-2">
            <li>I've obtained a flight dispatchers' diploma and worked in the control tower of a small airport on a border island, as part of my military service. 👨🏻‍✈️✈️</li>
            <li>In the past, I used to play online poker and had won several tournaments at small stakes, the largest of which had 3600 participants. 🃏🏆</li>
