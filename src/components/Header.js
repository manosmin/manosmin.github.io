...
const Header = () => {
  return (
    ...
    <h2 class="text-4xl font-bold dark:text-slate-100">Manos Minadakis<small class="ms-2 font-semibold text-gray-500 dark:text-gray-400">Computer Engineer</small></h2>
    <nav>
        <ul className="flex text-slate-100 mt-3 list-none">
